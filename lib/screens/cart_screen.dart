...
class _CartScreenState extends State<CartScreen_taruna> {
  final List<Map<String, dynamic>> cartItems = [
    {'name': 'Nasi Goreng', 'price': 15000, 'quantity': 1, 'image': 'assets/images/nasi_goreng.jpg'},
    {'name': 'Sate Kambing', 'price': 35000, 'quantity': 2, 'image': 'assets/images/sate_kambing.jpg'},
    {'name': 'Soto Ayam', 'price': 20000, 'quantity': 3, 'image': 'assets/images/soto_ayam.jpg'},
    {'name': 'Rujak Lontong', 'price': 12000, 'quantity': 4, 'image': 'assets/images/rujak_lontong.jpg'},
  ];
  ...
  void _incrementQuantity(int index) => setState(() => cartItems[index]['quantity']++);
  void _decrementQuantity(int index) => setState(() {
        if (cartItems[index]['quantity'] > 1) cartItems[index]['quantity']--;
      });
  void _removeItem(int index) => setState(() => cartItems.removeAt(index));
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => CheckoutScreen_Rapli(
          cartItems_Rapli: cartItems,
          totalPrice_Rapli: totalPrice,
                ...
                children: [
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            subtitle: Text('Rp ${item['price']}', style: TextStyle(color: Colors.white70)),
                            trailing: Row(
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                IconButton(icon: Icon(Icons.remove, color: Colors.white), onPressed: () => _decrementQuantity(index)),
                                Text('${item['quantity']}', style: TextStyle(color: Colors.white)),
                                IconButton(icon: Icon(Icons.add, color: Colors.white), onPressed: () => _incrementQuantity(index)),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text('Total: Rp ${totalPrice.toInt()}', style: TextStyle(color: Colors.white, fontSize: 18)),
                        ElevatedButton(
